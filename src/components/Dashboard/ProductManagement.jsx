      ...
      <table className="w-full min-w-max text-right">
        <thead className="bg-gray-100">
          <tr>
            ...
            <th scope="col" className="p-4 font-semibold text-gray-600">الاسم</th>
            <th scope="col" className="p-4 font-semibold text-gray-600">السعر</th>
            <th scope="col" className="p-4 font-semibold text-gray-600">الفئة</th>
