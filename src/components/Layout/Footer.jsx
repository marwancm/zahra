        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 text-center md:text-right">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-sm flex items-center justify-center md:justify-start">
            ...
            <div className="flex justify-center md:justify-start space-x-4 rtl:space-x-reverse mt-6">
              <a href="https://www.instagram.com/zhrt_alatw" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/70 hover:text-white transition-colors">
                <Instagram size={28} aria-hidden="true" />
              </a>
              <a href="https://wa.me/96876347266?text=" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-white/70 hover:text-white transition-colors">
