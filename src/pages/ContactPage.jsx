            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              >
                ...
                <div className="flex items-center space-x-3 rtl:space-x-reverse text-lg text-gray-700">
                  <MapPin size={24} className="text-[#a65b86]" />
                  <span>سلطنة عُمان</span>
                </div>
                <div className="flex items-center space-x-3 rtl:space-x-reverse text-lg text-gray-700">
                  <PhoneCall size={24} className="text-[#a65b86]" />
                ...
                <div className="flex space-x-4 rtl:space-x-reverse">
                  <a href="https://www.instagram.com/zhrt_alatw" target="_blank" rel="noopener noreferrer" className="text-[#a65b86] hover:text-[#8f436a] transition-colors">
                    <Instagram size={30} />
                  </a>
                  <a href="https://wa.me/96876347266?text=" target="_blank" rel="noopener noreferrer" className="text-[#a65b86] hover:text-[#8f436a] transition-colors">
